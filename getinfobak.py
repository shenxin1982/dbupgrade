...
def Usage():
    ...
    print '-m,--parameter::<osinfo,sysparm,dbinfo,dbfsinfo,db2set,dbmcfg,dbcfg,ckprod,vginfo,network,userinfo,dbstat,dbobject>'
    ...
    print 'dbobject: get database object info'
...
if __name__ == '__main__':
    ...
    if lhostname!=hostname:
        ...
        print outputdict['db2set']['DB2_MAX_GLOBAL_SNAPSHOT_SIZE']
